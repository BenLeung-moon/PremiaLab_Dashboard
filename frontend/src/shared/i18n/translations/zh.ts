export default {
  ...
  chat: {
    ...
    welcomeMessage: "我可以帮您分析投资组合，提供市场洞察，并回答投资相关问题。",
    welcomeDescription: "我可以帮您分析投资组合，提供市场洞察，并回答投资相关问题。",
    newChatTitle: "新对话",
    newChatDescription: "输入消息开始新对话。我将帮助您分析投资组合并提供投资洞察。",
    deleteConfirm: "确定要删除此对话吗？",
    delete: "删除",
    editTitle: "编辑标题",
    editTitlePlaceholder: "输入对话标题",
    options: "选项",
    aiAssistant: "AI助手",
    backToChat: "返回对话",
    ...
    apiError: "调用AI服务时发生错误，请检查您的网络连接或API密钥。",
    apiKeyMissing: "请先设置API密钥才能使用AI服务。",
    conversation: "对话",
    systemPrompt: "你是一个投资组合分析助手，提供投资相关的建议和分析。"
  },
  portfolio: {
    title: "投资组合",
    ...
    createNew: "创建新投资组合",
    totalWeight: "总权重",
    manualInput: "手动创建投资组合",
    pleaseSelectFromSuggestions: "请从下拉建议列表中选择股票"
  },
  settings: {
    title: "设置",
